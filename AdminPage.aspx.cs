...
public partial class Admin : System.Web.UI.Page
{
    ...
    protected void ButtonSaveLecturerSubject_Click(object sender, EventArgs e)
    {
        ...
        {
            sqlConnection.ConnectionString = ConfigurationManager.ConnectionStrings["mycon"].ConnectionString;
    ...
    {
        string mycon = System.Configuration.ConfigurationManager.ConnectionStrings["mycon"].ConnectionString;
